...
import { Plus, Pencil, Trash2, GitMerge, UserPlus, Boxes } from 'lucide-react';
...
interface Props {
  type?: 'vegetable_receiver' | 'wholesale';
}

const WholesaleCustomersPage: React.FC<Props> = ({ type = 'vegetable_receiver' }) => {
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 w-full flex-1 flex flex-col -mt-2 min-h-0">
      ...
      <div className="md:bg-white md:rounded-2xl md:border md:border-border md:shadow-sm flex flex-col flex-1 min-h-0 md:overflow-hidden -mx-4 sm:mx-0">
        {isLoading ? (
          ...
          <EmptyState title={searchTerm ? "Không tìm thấy vựa" : "Chưa có khách hàng"} />
        ) : (
