...
export function FloatingButtons() {
  return (
    <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-3">
      <motion.a href={phoneHref} aria-label="Gọi Nhà xe Năm Sự" className="route-pulse grid h-14 w-14 place-items-center rounded-full bg-[#E11D2E] text-white shadow-2xl shadow-red-600/35" animate={{ scale: [1, 1.08, 1] }} transition={{ duration: 1.8, repeat: Infinity }} whileHover={{ scale: 1.12 }}>
